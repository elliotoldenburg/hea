/*
  # Update progress tracking to handle rep ranges correctly

  1. Changes
    - Drop and recreate table with new schema
    - Add rep range support
    - Fix data tracking for UI filtering
*/
...
CREATE TABLE progress_tracking_logs (
  ...
  -- Make unique constraint include reps to allow multiple entries per workout/exercise
...
BEGIN
  ...
  -- Insert or update best set for each unique rep count
