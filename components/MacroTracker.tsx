...
export default function MacroTracker({ onClose }: Props) {
  ...
  const [showFoodSearchScreen, setShowFoodSearchScreen] = useState(false);
  ...
  const [currentMealName, setCurrentMealName] = useState('Frukost');
    ...
    try {
      ...
      while (retryCount <= maxRetries) {
        try {
          ...
          throw err; // Max retries reached, rethrow the error
        }
      }
  ...
  // If the food search screen is shown, render it instead
  if (showFoodSearchScreen) {
    return (
      <FoodSearchScreen 
        onClose={() => setShowFoodSearchScreen(false)} 
        mealName={currentMealName}
        onMealAdded={fetchNutritionData}
      />
    );
  }
        ...
        {error ? (
          ...
          <>
            ...
            >
              ...
              <Text style={styles.viewNutritionText}>VISA NÄRINGSVÄRDEN</Text>
            </Pressable>
            ...
            <Pressable 
              ...
              onPress={() => {
                setCurrentMealName('Frukost');
                setShowFoodSearchScreen(true);
              }}
            >
              <Text style={styles.logFoodButtonText}>Logga måltid</Text>
            </Pressable>

            <View style={styles.mealsContainer}>
              <Text style={styles.sectionTitle}>
                IDAG, {format(new Date(), 'MMM d', { locale: sv }).toUpperCase()}
              </Text>
