/*
  # Add user and workout history data
...
INSERT INTO auth.users (
  ...
  'eaa2f7e3-8acc-4739-9b73-e61e2e9cb168',
...
WITH workout_data AS (
  ...
  FROM workout_logs
  WHERE user_id = 'eaa2f7e3-8acc-4739-9b73-e61e2e9cb168'
)
...
WITH exercise_data AS (
  ...
  WHERE w.user_id = 'eaa2f7e3-8acc-4739-9b73-e61e2e9cb168'
)
